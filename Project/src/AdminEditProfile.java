...
public class AdminEditProfile implements ActionListener {
    ...
    private void updateData(){
        ...
        try {
            ...
            String sql = "UPDATE AdminTable SET NAME = ?, AGE = ?, GENDER = ?, CONTACT = ?, EMAIL = ? WHERE ID = ?";
